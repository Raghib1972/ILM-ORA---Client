...
let messaging;
// getMessaging() needs serviceWorker/Notification browser APIs that don't
// exist during Next.js's server render (this module runs there too, even
// though it's "use client" — that flag only controls hydration, not
// whether the module body executes on the server). The Vite app never hit
// this because it only ever ran in a real browser. Guarding it here is
// SSR-safety only: every actual browser still initializes exactly as before.
