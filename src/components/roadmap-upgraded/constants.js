...
// Every role now shares one monochrome black/neutral accent (matches the
// shared design-system BUTTON_DARK / pillBg tokens — see roadmapUpgraded.css)
// instead of a per-role green/orange/purple color. Copy, permissions and
// basePath are unchanged.
const MONO_ACCENT = "#2B2926";
const MONO_ACCENT_SOFT = "#F0EEE8";
const MONO_ACCENT_GLOW = "rgba(31,30,27,.06)";

export const ROLE_CONFIG = {
  student: {
    accent: MONO_ACCENT,
    accentSoft: MONO_ACCENT_SOFT,
    accentGlow: MONO_ACCENT_GLOW,
