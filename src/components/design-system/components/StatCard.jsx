...
const StatCard = ({ stat, index, loading, mode }) => {
  ...
  const labelColor = resolvedMode === "dark" ? "rgba(255,255,255,0.55)" : "#6F6B64";
    ...
    >
      ...
      <div>
        {loading ? (
          ...
          <p style={{ fontSize: 26, fontWeight: 600, lineHeight: 1, fontFamily: FONT_FAMILY, color: valueColor, margin: 0 }}>
