...
export const T = {
  ...
  // ── "Claude" light theme — matches the reference Claude.ai screenshot
  // exactly: warm cream sidebar/page, white cards, charcoal text, terracotta
  // accent. Every hex below is taken 1:1 from the reference swatch strip
  // (Sidebar #F0EEE8 / Dashboard #F7F6F2 / Card #FFFFFF / Text #1F1E1B /
