...
const AttemptQuiz = () => {
  ...
  useEffect(() => {
    assessmentService.getQuizAttemptUsage()
      ...
      <PageContainer mode={isDark ? "dark" : "light"} pageBg={t.pageBg} textColor={t.text}>
        <div style={{ display:"flex", alignItems:"center", justifyContent:"center", minHeight:"60vh" }}>
          <div style={{ background:t.cardBg, border:`1px solid ${t.border}`, borderRadius:24, padding:"48px 56px", textAlign:"center", maxWidth:420, boxShadow:t.shadow }}>
            ...
            <button
              onClick={() => navigate(`/ilm-demo?section=${encodeURIComponent("/student/assessments")}`)}
      ...
      <div className="dfade" style={{ padding:"8px 0 24px", background:"transparent", border:"none", borderBottom:`1px solid ${t.borderHero}`, marginBottom:20, boxShadow:"none" }}>
        <div className="hero-flex">
          ...
          <div className="hero-badges">
            ...
            {usage && (
              <div style={{ display:"flex", alignItems:"center", gap:7, background:t.actBg, border:`1px solid ${t.actBorder}`, borderRadius:999, padding:"8px 16px", fontSize:11, fontWeight:FONT_WEIGHT.semibold, fontFamily:FONT_FAMILY, color:t.textSub }}>
              {usage.limit === "unlimited" ? "Unlimited attempts" : `${usage.used}/${usage.limit} attempts this month`}
            </div>
            )}
          </div>
        </div>
