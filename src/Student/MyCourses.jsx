...
import { T, StatCard, PageContainer, FONT_FAMILY, FONT_WEIGHT, FONT_SIZE, LETTER_SPACING, LINE_HEIGHT, CLAUDE_ACCENT } from "@/design-system";
    ...
    <PageContainer mode={isDark ? "dark" : "light"} pageBg={t.pageBg} textColor={t.text}>
      ...
      {loading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {lockedCount > 0 && (
            <div style={{ padding: "18px 20px", borderRadius: 16, background: t.emptyBg, border: `1px dashed ${t.emptyBorder}`, textAlign: "center", marginTop: 20 }}>
              <p style={{ fontSize: 13, fontWeight: FONT_WEIGHT.semibold, color: t.text, margin: "0 0 4px", fontFamily: FONT_FAMILY }}>
                🔒 {lockedCount} more course{lockedCount > 1 ? "s" : ""} locked
              </p>
              <p style={{ fontSize: 11.5, color: t.textMuted, margin: "0 0 12px", fontFamily: FONT_FAMILY }}>
                {planSummary
              ...
              <button
                ...
                style={{ padding: "8px 18px", borderRadius: 10, border: "none", background: CLAUDE_ACCENT, color: "#fff", fontSize: 12, fontWeight: FONT_WEIGHT.bold, cursor: "pointer", fontFamily: FONT_FAMILY }}
              >
                Upgrade Plan
              </button>
            </div>
