...
const GLOBAL_STYLE = `
  * { box-sizing: border-box; }
  ...
  ::-webkit-scrollbar-thumb { background: ${CLAUDE_ACCENT}; border-radius: 3px; }
...
/* Global styles are rendered via <style>{GLOBAL_STYLE}</style> inside
   ResumeBuilder's JSX below instead of being injected into document.head
   at module scope, since document isn't available during Next.js SSR. */

/* ─── Theme Color Palettes ───────────────────────────────────────────────── */
const DARK_C = {
  bg: T.dark.pageBg,
  card: T.dark.cardBg,
  card2: T.dark.cardBgHov,
  card3: T.dark.recentItemBg,
  border: T.dark.border,
  borderHover: T.dark.borderHov,
  orange: "#F5F5F0", // off-white — Dashboard ke black/off-white icon buttons jaisa
  orangeD: "#FFFFFF", // hover par pure white
  orangeGlow: "rgba(255,255,255,0.12)",
  green: T.dark.statusCompletedText,
  greenGlow: T.dark.statusCompletedBg,
  text: T.dark.text,
  textSub: T.dark.textSub,
  muted: T.dark.textMuted,
  red: T.dark.overdueText,
  redGlow: T.dark.overdueBg,
  blue: STAT_COLORS_FLAT.blue.solid,
  blueGlow: STAT_COLORS_FLAT.blue.soft,
  purple: T.dark.statusProgressText,
  purpleGlow: T.dark.statusProgressBg,
  inputBg: T.dark.inputBg,
  inputBorder: T.dark.border,
  inputFocus: CLAUDE_ACCENT,
  canvasBg: T.dark.pageBg,
  scoreBg: T.dark.recentItemBg,
  dropBg: T.dark.recentItemBg,
  resultBg: T.dark.recentItemBg,
  previewThumbBg: T.dark.barBg,
  navBg: T.dark.cardBg,
  shadow: T.dark.shadow,
  shadowCard: T.dark.shadow,
  shadowHover: T.dark.shadowHov,
  isDark: true,
};
...
const LIGHT_C = {
  bg: T.light.pageBg,
  card: T.light.cardBg,
  card2: T.light.cardBgHov,
  card3: T.light.recentItemBg,
  border: T.light.border,
  borderHover: T.light.borderHov,
  orange: "#111111", // black — Dashboard ke bell/moon icon jaisa
  orangeD: "#000000", // hover par pure black
  orangeGlow: "rgba(0,0,0,0.08)",
  green: T.light.statusCompletedText,
  greenGlow: T.light.statusCompletedBg,
  text: T.light.text,
  textSub: T.light.textSub,
  muted: T.light.textMuted,
  red: T.light.overdueText,
  redGlow: T.light.overdueBg,
  blue: STAT_COLORS_FLAT.blue.solid,
  blueGlow: STAT_COLORS_FLAT.blue.soft,
  purple: T.light.statusProgressText,
  purpleGlow: T.light.statusProgressBg,
  inputBg: T.light.inputBg,
  inputBorder: T.light.border,
  inputFocus: CLAUDE_ACCENT,
  canvasBg: T.light.pageBg,
  scoreBg: T.light.recentItemBg,
  dropBg: T.light.recentItemBg,
  resultBg: T.light.recentItemBg,
  previewThumbBg: T.light.barBg,
  navBg: T.light.cardBg,
  shadow: T.light.shadow,
  shadowCard: T.light.shadow,
  shadowHover: T.light.shadowHov,
  isDark: false,
};
...
/* ─── useDarkMode Hook ───────────────────────────────────────────────────
   Now delegates to the shared design-system hook (same "dark" class /
   data-theme detection every other page uses) instead of this page's own
   copy, which previously checked different localStorage keys and could
   disagree with the rest of the app about which theme is active. */
...
function HomePage({ onCreateResume, resumes, onFeatureClick }) {
  ...
  return (
    <div
      style={{ fontFamily: FONT_FAMILY, background: C.bg, minHeight: "100vh" }}
    >
      {/* Hero */}
      <div
        className="rb-hero"
      ...
      >
        {/* Flat background — glow circles & gradient layers removed to match dashboard's flat design language */}
        ...
        >
          ...
          <h1
            className="font-black leading-[1.1] tracking-[-0.5px]"
            style={{
...
function TemplateGallery({
  ...
  return (
    <div
      style={{ minHeight: "100vh", background: C.bg, fontFamily: FONT_FAMILY }}
    >
      {/* Header */}
      <div
        style={{
...
/* ─── Main App ────────────────────────────────────────────────────────────── */
export default function ResumeBuilder({ theme, toggleTheme }) {
  ...
  // Central handler for any plan-limit error from AI-generate / PDF-parse /
  // LinkedIn-scrape. Returns true if handled.
  ...
  const globalStyleTag = <style>{GLOBAL_STYLE}</style>;
