...
import { T, PageContainer, CLAUDE_ACCENT } from "@/design-system";
...
export default function StudentAssignments() {
  ...
  const handleNavigate = (a, index) => {
    ...
    navigate(`/ilm-demo?section=${encodeURIComponent(`/student/assignments/${a.id}`)}`);
  };
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, flexWrap: "wrap" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: CLAUDE_ACCENT }} />
              <span style={{
