...
const Documents = () => {
  ...
  useEffect(() => {
    ...
    fileService.getStudentFileCount().then((res) => {
  ...
  return (
    <PageContainer mode={isDark ? "dark" : "light"} pageBg={t.pageBg} textColor={t.text}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {lockedCount > 0 && (
          <div style={{ padding: "18px 20px", borderRadius: 16, background: t.emptyBg, border: `1px dashed ${t.emptyBorder}`, textAlign: "center" }}>
