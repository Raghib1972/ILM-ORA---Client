...
const pct = Number.isFinite(pctNum) ? pctNum.toFixed(1) : "0.0";
  ...
  const statusBadge = (s) => (
    <span style={badgeStyle(s === "Present" ? t.text : (STATUS_COLOR[s] || t.textMuted))}>{s}</span>
  );
  const statusIcon = (s) => {
    if (s === "Present") return <CheckCircle size={16} style={{ color: t.text }} />;
  ...
  const filterBtnStyle = (disabled) => ({
    ...
    background: BUTTON_DARK, color: "#ffffff", opacity: disabled ? 0.5 : 1,
        ...
        <div className="hero-flex">
          <div>
            ...
            <h1 style={{
              ...
              color: t.text, margin: "0 0 6px", lineHeight: LINE_HEIGHT.heroTitle, letterSpacing: LETTER_SPACING.heroTitle,
            }}>
              Attendance
            </h1>
          ...
          <div className="hero-badges">
            <div style={{ display: "flex", alignItems: "center", gap: 12, background: t.actBg, border: `1px solid ${t.actBorder}`, borderRadius: 12, padding: "8px 16px", fontSize: 11, fontWeight: FONT_WEIGHT.semibold, fontFamily: FONT_FAMILY, color: t.textSub }}>
              ...
              <span style={{ width: 1, height: 14, background: t.actBorder }} />
              <span style={{ color: t.text, fontWeight: FONT_WEIGHT.bold }}>{pct}% rate</span>
            </div>
            ...
            <div className="livebadge" style={{ display: "flex", alignItems: "center", gap: 7, background: "rgba(31,30,27,0.06)", border: "1px solid rgba(31,30,27,0.2)", borderRadius: 999, padding: "8px 18px", color: t.text, fontSize: 11, fontWeight: FONT_WEIGHT.bold, letterSpacing: "0.1em", fontFamily: FONT_FAMILY }}>
      ...
      >
        ...
        <div style={{ width: `${leftWidth}%`, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: "30%" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "14px 20px", borderBottom: `1px solid ${t.border}`, flexShrink: 0, background: t.recentItemBg }}>
            <BarChart3 size={15} style={{ color: t.textSub }} />
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 8, padding: "12px 20px", borderBottom: `1px solid ${t.border}`, background: t.recentItemBg }}>
            ...
            <button style={filterBtnStyle(filterLoading)} disabled={filterLoading} onClick={loadFilteredHistory}>
              {filterLoading ? "Loading…" : "Search"}
            </button>
            <button style={filterBtnStyle(downloading)} disabled={downloading} onClick={handleDownload}>
        ...
        <div style={{ flex: 1, minWidth: "20%", display: "flex", flexDirection: "column", overflowY: "auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "14px 20px", borderBottom: `1px solid ${t.border}`, flexShrink: 0, background: t.recentItemBg }}>
            <TrendingUp size={15} style={{ color: t.textSub }} />
          ...
          <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 18 }}>
            <div>
              ...
              <div style={{ borderRadius: 14, padding: 18, textAlign: "center", background: t.recentItemBg, border: `1px solid ${t.border}` }}>
                <p style={{ fontSize: 40, fontWeight: FONT_WEIGHT.bold, color: t.text, lineHeight: 1, margin: "0 0 4px" }}>{pct}%</p>
                ...
                <div style={{ height: 8, borderRadius: 99, background: t.border, overflow: "hidden" }}>
                  <div style={{ height: "100%", borderRadius: 99, width: `${pct}%`, background: t.text, transition: "width 0.5s" }} />
                </div>
              </div>
            </div>
