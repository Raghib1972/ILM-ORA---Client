...
// NEXT.JS FIX: import.meta.env is Vite-only and does not exist in Next.js.
// Next.js only exposes env vars prefixed NEXT_PUBLIC_ to the client bundle,
// so this now reads from process.env.NEXT_PUBLIC_LIVEKIT_URL instead.
// Make sure your .env.local defines NEXT_PUBLIC_LIVEKIT_URL (not
// VITE_LIVEKIT_URL, which Next.js will never load).
const LIVEKIT_URL =
