...
// Next.js serves files under public/ directly by URL path — unlike Vite,
// it doesn't support `import x from "/public-file.ext"` to get a URL.
// These are the same already-migrated assets (public/fde-academy-assets/),
// just referenced as plain strings instead of imported.
const slide1 = "/fde-academy-assets/1.webp";
const slide2 = "/fde-academy-assets/2.webp";
const slide3 = "/fde-academy-assets/3.webp";
const slide4 = "/fde-academy-assets/4.webp";
// ✅ Shared shell used by every other public page (Careers, About, Pricing,
// Terms of Service, etc). Rendering inside it gives this page the exact
// same AnnouncementBanner → Navbar → ... → Footer as every other public
// page — so there is only ONE navbar and ONE footer across the whole site.
