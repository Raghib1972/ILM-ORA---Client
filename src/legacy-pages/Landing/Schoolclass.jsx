...
// These 4 board logo assets do not exist anywhere in the source repo
// (confirmed against the original Vite app) — the original code already
// falls back to null for all of them via try/catch at runtime. Next.js's
// webpack bundler resolves require() paths statically at build time and
// errors even inside a try/catch for a file that's genuinely missing, so
// this reproduces the exact same always-null outcome without breaking the
// production build. No visual change: these logos were already never
// rendering in the existing app.
let cbseLogo = null, biharLogo = null, icseLogo = null, upLogo = null;
      ...
      <div className={`sc-wrap${darkMode ? " dark-mode" : ""}`}>
        ...
        <section className="sc-hero">
          ...
          <div className="sc-hero-right">
            <div className="sc-hero-img-wrapper"><img src={schoolImg.src} alt="Student studying" /></div>
