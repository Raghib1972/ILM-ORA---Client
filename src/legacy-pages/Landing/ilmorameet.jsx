...
const INTEGRATIONS_ROW_1 = [
  { name: "Zoom", icon: zoomIcon.src },
  { name: "Google Calendar", icon: googleCalendarIcon.src },
  { name: "Gmail", icon: gmailIcon.src },
  { name: "HubSpot", icon: hubspotIcon.src },
  { name: "Slack", icon: slackIcon.src },
  { name: "Microsoft Teams", icon: teamsIcon.src },
  { name: "Chrome", icon: chromeIcon.src },
  { name: "LinkedIn", icon: linkedinIcon.src },
];
const INTEGRATIONS_ROW_2 = [
  { name: "OpenAI", icon: openaiIcon.src },
  { name: "Claude", icon: claudeIcon.src },
  { name: "Greenhouse", icon: greenhouseIcon.src },
  { name: "Microsoft", icon: microsoftIcon.src },
  { name: "PayPal", icon: paypalIcon.src },
  { name: "Salesforce", icon: salesforceIcon.src },
  { name: "Google Meet", icon: meetIcon.src },
];

const INTEGRATION_SUITES = [
  {
    icon: googleCalendarIcon.src,
