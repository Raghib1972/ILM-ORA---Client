    ...
    <>
      <style>{`
        ...
        .d-page[data-theme="light"] {
          /* Claude reference palette — recalibrated 2026-09-10 from an actual
             pixel sample of claude.ai (not an approximation): Sidebar #FBFBF9 /
             Dashboard #FCFCFB / Card #FFFFFF / Text #1F1E1B / Secondary #83827A
             (matches the sidebar's own muted text color) / Border #DEDAD2 /
             Accent #D97757 / Button Dark #2B2926 */
          --d-green:#16a34a; --d-orange:#D97757; --d-dark:#2B2926; --d-cream:#FBFBF9;
          --d-white:#fff; --d-gray:#83827A; --d-light:#FCFCFB;
          --d-bg:#FCFCFB; --d-bg2:#fff; --d-card-bg:#fff; --d-card-border:#DEDAD2;
          --d-nav-bg:#fff; --d-nav-border:#DEDAD2;
          --d-text:#1F1E1B; --d-text-muted:#83827A;
          --d-stats-bg:#2B2926; --d-stats-text:rgba(255,255,255,.55);
          --d-footer-bg:#fff; --d-footer-border:#DEDAD2;
          --d-hero-bg: linear-gradient(135deg,#FCFCFB 0%,#fff 60%,#FCFCFB 100%);
          --d-hero-title:#1F1E1B; --d-hero-sub:#83827A; --d-hero-greeting:#9A968C; --d-hero-name:#1F1E1B;
          --d-tab-bg:#fff; --d-tab-border:#DEDAD2; --d-tab-color:#83827A;
          --d-toggle-bg:#FCFCFB; --d-toggle-border:#DEDAD2; --d-toggle-icon:#D97757;
          --d-dd-bg:#ffffff; --d-dd-border:#DEDAD2; --d-dd-shadow:0 16px 48px rgba(31,30,27,0.12);
          --d-dd-header-name:#1F1E1B; --d-dd-header-email:#83827A; --d-dd-divider:#F0EEE8;
          --d-dd-item-color:#3A3833; --d-dd-item-hover-bg:#FAF8F4; --d-dd-item-hover-color:#1F1E1B;
          --d-dd-upgrade-color:#D97757; --d-dd-upgrade-hover-bg:rgba(217,119,87,0.08);
