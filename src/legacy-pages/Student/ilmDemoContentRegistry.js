...
// // ─── Migration status note (framework-plumbing only, no logic change) ───
// // Task 6 (Admin module) has landed — src/Admin/* now exists in this
// // project, so AdminSections below is live, matching StudentSections and
// // TrainerSections.

// /* ─── Role home dashboards (shown when no sidebar item is selected) ───── */
// const RoleHome = {
//   student: lazy(() => import("../../Student/DashboardPage.jsx")),
//   trainer: lazy(() => import("../../Trainer/Dashboard.jsx")),
...
// /* ─── Trainer sidebar items (path -> real page component) ─────────────── */
// const TrainerSections = {
//   "/trainer": RoleHome.trainer,
//   "/trainer/batches": lazy(() => import("../../Trainer/TrainerBatchesPage.jsx")),
//   "/trainer/workspace": lazy(() => import("../../Trainer/TrainerMeetings.jsx")),
//   "/trainer/upload-videos": lazy(() => import("../../Trainer/UploadVideos.jsx")),
//   "/trainer/course-management": lazy(() =>
//     import("../../Trainer/TrainerCourseManagement.jsx"),
//   ),
//   "/trainer/assessments": lazy(() => import("../../Trainer/Assessments.jsx")),
//   "/trainer/attendance": lazy(() => import("../../Trainer/Attendance.jsx")),
//   "/trainer/doubts-management": lazy(() =>
//     import("../../Trainer/DoubtsManagement.jsx"),
//   ),
//   "/trainer/feedback": lazy(() => import("../../Trainer/Trainerfeedback.jsx")),
//   "/trainer/live": lazy(() => import("../../Trainer/TrainerLiveClasses.jsx")),
//   "/trainer/whiteboard": lazy(() => import("../../Trainer/WhiteboardPanel.jsx")),
//   "/trainer/ai-companion": lazy(() =>
//     import("../../Trainer/AiCompanionPanel.jsx"),
//   ),
//   "/trainer/student-reports": lazy(() => import("../../Trainer/StudentReports.jsx")),
//   "/trainer/batch-reports": lazy(() => import("../../Trainer/BatchReports.jsx")),
//   "/trainer/performance": lazy(() =>
//     import("../../Trainer/PerformanceAnalysis.jsx"),
//   ),
...
// ─── Dynamic Trainer Classroom ─────────────────────────────────────────
const TrainerClassroomComponent = lazy(() =>
  import("../../Trainer/TrainerClassroomPage.jsx"),
);
...
const StudentSections = {
  "/student": RoleHome.student,
  "/student/workspace": lazy(() =>
    import("../../Student/StudentMeetings.jsx"),
  ),
  "/student/live-classes": lazy(() =>
    import("../../Student/LiveClasses.jsx"),
  ),
  "/student/recorded-classes": lazy(() =>
    import("../../Student/RecordedClasses.jsx"),
  ),
  "/student/videos": lazy(() =>
    import("../../Student/videolecctures.jsx"),
  ),
  "/student/documents": lazy(() =>
    import("../../Student/Documents.jsx"),
  ),
  "/student/courses": lazy(() =>
    import("../../Student/MyCourses.jsx"),
  ),
  "/student/assessments": lazy(() =>
    import("../../Student/Assessments.jsx"),
  ),
  "/student/assignments": lazy(() =>
    import("../../Student/StudentAssignments.jsx"),
  ),
  "/student/my-quizzes": lazy(() =>
    import("../../Student/MyQuizHistory"),
  ),
  "/student/attendance": lazy(() =>
    import("../../Student/Attendance.jsx"),
  ),
  "/student/skill-map": lazy(() =>
    import("../../Student/SkillMap.jsx"),
  ),
  "/student/certificates": lazy(() =>
    import("../../Student/certificates.jsx"),
  ),
  "/student/notebook": lazy(() =>
    import("../../Student/StudentNotebook.jsx"),
  ),
  "/student/resume-builder": lazy(() =>
    import("../../Student/ResumeBuilder.jsx"),
  ),
  "/student/doubts": lazy(() =>
    import("../../Student/Doubts.jsx"),
  ),
  "/student/feedback": lazy(() =>
    import("../../Student/Studentfeedback.jsx"),
  ),
  "/student/compiler": lazy(() =>
    import("../../Student/StudentCompilerPage.jsx"),
  ),
...
const TrainerSections = {
  "/trainer": RoleHome.trainer,
  "/trainer/batches": lazy(() =>
    import("../../Trainer/TrainerBatchesPage.jsx"),
  ),
  "/trainer/workspace": lazy(() =>
    import("../../Trainer/TrainerMeetings.jsx"),
  ),
  "/trainer/upload-videos": lazy(() =>
    import("../../Trainer/UploadVideos.jsx"),
  ),
  "/trainer/course-management": lazy(() =>
    import("../../Trainer/TrainerCourseManagement.jsx"),
  ),
  "/trainer/assessments": lazy(() =>
    import("../../Trainer/Assessments.jsx"),
  ),
  "/trainer/attendance": lazy(() =>
    import("../../Trainer/Attendance.jsx"),
  ),
  "/trainer/doubts-management": lazy(() =>
    import("../../Trainer/DoubtsManagement.jsx"),
  ),
  "/trainer/feedback": lazy(() =>
    import("../../Trainer/Trainerfeedback.jsx"),
  ),
  "/trainer/live": lazy(() =>
    import("../../Trainer/TrainerLiveClasses.jsx"),
  ),
  "/trainer/whiteboard": lazy(() =>
    import("../../Trainer/WhiteboardPanel.jsx"),
  ),
  "/trainer/ai-companion": lazy(() =>
    import("../../Trainer/AiCompanionPanel.jsx"),
  ),
  "/trainer/student-reports": lazy(() =>
    import("../../Trainer/StudentReports.jsx"),
  ),
  "/trainer/batch-reports": lazy(() =>
    import("../../Trainer/BatchReports.jsx"),
  ),
  "/trainer/performance": lazy(() =>
    import("../../Trainer/PerformanceAnalysis.jsx"),
  ),
...
const AdminSections = {
  ...
  "/admin/workspace": lazy(() =>
    import("../../Admin/AdminMeetings.jsx"),
  ),
  "/admin/organisation-overview": lazy(() =>
    import("../../Admin/OrganisationOverview"),
  ),
  ...
  "/admin/access-control": lazy(() =>
    import("../../Admin/AccessControlPage"),
  ),
  "/admin/courses": lazy(() =>
    import("../../Admin/AllCourses"),
  ),
  "/admin/videos": lazy(() =>
    import("../../Admin/AdminVideos"),
  ),
  "/admin/files": lazy(() =>
    import("../../Admin/AdminFiles"),
  ),
  "/admin/live-sessions": lazy(() =>
    import("../../Admin/AdminLiveSessions"),
  ),
  "/admin/certificates": lazy(() =>
    import("../../Admin/CertificatesAdmin"),
  ),
  "/admin/reports": lazy(() =>
    import("../../Admin/OrgReports"),
  ),
  "/admin/usage": lazy(() =>
    import("../../Admin/UsageAnalytics"),
  ),
  "/admin/skill-analytics": lazy(() =>
    import("../../Admin/AdminSkillDashboard.jsx"),
  ),
  "/admin/feedback-review": lazy(() =>
    import("../../Admin/Adminfeedback.jsx"),
  ),
  "/admin/attendance": lazy(() =>
    import("../../Admin/AdminAttendance"),
  ),
  "/admin/settings": lazy(() =>
    import("../../Admin/OrgSettings"),
  ),
  "/admin/roadmap-upgraded": lazy(() =>
    import("../../Admin/AdminRoadmapUpgraded.jsx"),
  ),
 ...
 * Returns the real production component for a given role + sidebar path.
 *
 * Static paths are resolved from SECTIONS_BY_ROLE.
 *
 * Dynamic Trainer Classroom:
 *   /trainer/batches/:id/students
 *
 * This remains inside the /ilm-demo shell and is resolved through
 * ?section=/trainer/batches/:id/students.
 */
export function getSectionComponent(roleKey, path) {
  // Dynamic "Open Classroom" section.
  if (
    roleKey === "trainer" &&
    /^\/trainer\/batches\/[^/]+\/students$/.test(path)
  ) {
    return TrainerClassroomComponent;
  }

  const sections =
    SECTIONS_BY_ROLE[roleKey] || SECTIONS_BY_ROLE.student;
