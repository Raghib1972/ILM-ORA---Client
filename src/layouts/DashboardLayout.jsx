...
import { CLAUDE_ACCENT, CLAUDE_ACCENT_HOVER } from "@/design-system";
...
const NotificationBanner = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Bell size={15} color={CLAUDE_ACCENT} />
      </span>
    ...
    {toasts.map((t) => {
      ...
      return (
        ...
        >
          ...
          >
            <Icon size={17} color={CLAUDE_ACCENT} />
          </div>
...
const PROFILE_MENU_CSS = `
  ...
  .dl-profile-avatar {
    ...
    background: linear-gradient(135deg, ${CLAUDE_ACCENT}, ${CLAUDE_ACCENT_HOVER});
      ...
      {unreadCount > 0 && (
        <span
          style={{
            ...
            justifyContent: "center",
            padding: "0 4px",
            boxShadow: "0 2px 6px rgba(217,119,87,0.45)",
