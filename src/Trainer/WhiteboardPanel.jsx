...
import { T, BUTTON_DARK, BUTTON_DARK_HOVER } from "@/design-system";
import {
  Layout,
  GitBranch,
  FolderOpen,
...
const WS_URL =
  (process.env.NEXT_PUBLIC_WS_BASE_URL || "ws://localhost:9000") + "/live-chat";
...
function BoardThumbnail({ type, isDark }) {
  const bg = isDark ? "#1e293b" : T.light.emptyBg;
  ...
  return THUMB_SVGS[type] || THUMB_SVGS.flow;
}
...
function WhiteboardCard({
  ...
  return (
    <div
      ...
      style={{
        borderRadius: 14,
        border: `1px solid ${isDark ? (hovered ? "rgba(59,130,246,0.4)" : "rgba(255,255,255,0.08)") : hovered ? "rgba(59,130,246,0.3)" : T.light.border}`,
        overflow: "hidden",
        background: isDark ? "#1e293b" : "#ffffff",
        transition: "all 0.2s",
        boxShadow: isDark
     ? (hovered ? "0 8px 32px rgba(0,0,0,0.2)" : "0 2px 8px rgba(0,0,0,0.06)")
     : (hovered ? T.light.shadowHov : T.light.shadow),
    ...
    >
      <div
        ...
        style={{
          height: 130,
          overflow: "hidden",
          background: isDark ? "#0f172a" : T.light.emptyBg,
        }}
      >
      ...
      <div style={{ padding: "10px 12px" }}>
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div
   style={{ fontSize: 10, color: isDark ? "#475569" : T.light.textSub }}
 >
   {board.owner}
 </div>
            <div
   style={{
     fontSize: 10,
     color: isDark ? "#334155" : T.light.textMuted,
     marginTop: 2,
   }}
 >
   {board.modified}
          ...
          >
            ...
            >
              <Star
               size={13}
               fill={board.starred ? (isDark ? "#f1f5f9" : "#0f172a") : "none"}
             />
            </button>
        ...
        {board.project && (
          <div
            style={{
              ...
              border: `1px solid ${isDark ? "rgba(255,255,255,0.1)" : T.light.border}`,
            }}
          >
            <FolderOpen size={9} color={isDark ? "#e2e8f0" : "#334155"} />
           <span
              style={{
                fontSize: 9,
    ...
    return (
      <div
        style={{
          ...
          minHeight: 560,
          position: "relative",
          background: isDark ? "#0f172a" : T.light.pageBg,
        }}
      >
        <div
          style={{
  ...
  return (
    <div
      style={{
        ...
        height: "calc(100vh - 120px)",
        minHeight: 560,
        background: isDark ? "#0a0f1e" : T.light.pageBg,
        overflow: "hidden",
      }}
    >
      {/* Sidebar */}
      <div
        style={{
          ...
          background: isDark ? "#0f172a" : "#f1f0ec",
        ...
        {!sidebarCollapsed && (
          <div style={{ padding: "10px 12px 6px" }}>
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = BUTTON_DARK_HOVER;
              }}
              onMouseLeave={(e) => {
                 e.currentTarget.style.background = BUTTON_DARK;
              }}
            >
          ...
          {sidebarItems.map(({ label, icon: Icon }) => {
            ...
            return (
              ...
              >
                <Icon
                  size={15}
                 color={active ? (isDark ? "#f1f5f9" : "#0f172a") : undefined}
              />
      ...
      >
        ...
        >
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                border: `1px solid ${isDark ? "rgba(255,255,255,0.1)" : "#e2e8f0"}`,
                background: isDark ? "rgba(255,255,255,0.03)" : "#f1f0ec",
                color: isDark ? "#e2e8f0" : "#334155",
                fontSize: 12,
                fontWeight: 600,
                cursor: "pointer",
            ...
            >
              <Icon size={13} color={isDark ? "#e2e8f0" : "#334155"} />
              {label}
            </button>
          ))}
          <div
          ...
          >
            {connected ? (
              <Wifi size={11} color={isDark ? "#e2e8f0" : "#334155"} />
            ) : (
              <WifiOff size={11} color={isDark ? "#e2e8f0" : "#334155"} />
            )}
            <span
              style={{
                fontSize: 10,
          ...
          <div style={{ position: "relative", maxWidth: 360 }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: 12,
                border: `1px solid ${isDark ? "rgba(255,255,255,0.1)" : "#e2e8f0"}`,
                background: isDark ? "rgba(255,255,255,0.04)" : "#f1f0ec",
                color: isDark ? "#f1f5f9" : "#0f172a",
                fontSize: 12,
                outline: "none",
                boxSizing: "border-box",
