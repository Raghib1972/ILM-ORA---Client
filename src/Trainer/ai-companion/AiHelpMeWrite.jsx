...
export default function AiHelpMeWrite({ isDark }) {
  ...
  const hoverBg = t.recentItemBgHov;
  const accentBg = isDark ? "rgba(217,119,87,0.08)" : "rgba(217,119,87,0.05)";
    ...
    >
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                padding: "7px 12px",
                borderRadius: 7,
                border: `1px solid ${contextLabel ? "#D97757" : border}`,
                background: contextLabel ? accentBg : "transparent",
                cursor: "pointer",
                color: contextLabel ? "#D97757" : textSecondary,
                fontSize: 12,
                fontWeight: 500,
                fontFamily: "'Poppins', sans-serif",
                transition: "all 0.15s",
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                background:
                  isLoading || !content.trim() ? t.iconBg : "#D97757",
                cursor:
                  isLoading || !content.trim() ? "not-allowed" : "pointer",
                ...
                boxShadow:
                  !isLoading && content.trim()
                    ? "0 2px 10px rgba(217,119,87,0.3)"
                    : "none",
                transition: "all 0.15s",
              }}
              onMouseEnter={(e) => {
              ...
              >
                <div
                  style={{
                    ...
                    textTransform: "uppercase",
                    color: "#D97757",
                    background: isDark ? "rgba(217,119,87,0.06)" : "#FCEAE3",
      ...
      >
        ...
        >
          ...
          >
            <Sparkles size={14} color="#D97757" style={{ flexShrink: 0 }} />
            <div style={{ flex: 1 }}>
              <div
                style={{
                  fontSize: 11,
