...
function StatusBadge({ status }) {
  ...
  const colors = {
    DRAFT: { bg: "rgba(226,145,111,0.1)", color: "#D97757" },
          ...
          >
            {recentWorkflows.map((wf) => (
              <div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = "#D9775744";
        ...
        >
          {QUICK_TEMPLATES.map((tmpl) => {
            ...
            return (
              <div
                key={tmpl.id}
                onClick={() => onSelectTemplate && onSelectTemplate(tmpl)}
                style={{
                  padding: "16px",
                  borderRadius: 12,
                  border: `1px solid ${border}`,
              ...
              >
                ...
                >
                  ...
                  >
                    <Icon size={15} color={textPrimary} />
                  </div>
                  <div>
                    <div
                      style={{
