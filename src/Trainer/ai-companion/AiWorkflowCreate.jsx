...
import { T, BUTTON_DARK } from "@/design-system";
import {
  Plus,
  Send,
  ChevronRight,
    ...
    >
      ...
      >
        <button
          ...
          onMouseEnter={(e) => (e.currentTarget.style.background = "#C2653F")}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 8,
              border: "none",
              background: saved ? "#059669" : saving ? "#6b7280" : "#D97757",
              color: "#fff",
              fontSize: 13,
              fontFamily: "'Poppins', sans-serif",
              fontWeight: 600,
            ...
            >
              <div
                style={{
                  ...
                  height: 56,
                  borderRadius: 14,
                  background: isDark ? "rgba(217,119,87,0.12)" : "#FCEAE3",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  margin: "0 auto 16px",
...
export default function AiWorkflowCreate({
  ...
  const accentBg = isDark ? "rgba(217,119,87,0.1)" : "#FCEAE3";
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 10,
            border: "none",
            background: prompt.trim() ? "#D97757" : "#d1d5db",
            color: "#fff",
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border: "none",
                background: promptSaving ? "#6b7280" : "#D97757",
                color: "#fff",
                fontSize: 12,
                fontFamily: "'Poppins', sans-serif",
                fontWeight: 600,
          ...
          {TEMPLATE_TABS.map((tab) => (
            <button
              ...
              style={{
                ...
                border: "none",
                background: activeTab === tab.id ? BUTTON_DARK : "transparent",
