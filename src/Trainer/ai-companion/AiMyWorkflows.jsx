...
function StatusBadge({ status }) {
  ...
  const colors = {
    DRAFT: {
      bg: "rgba(226,145,111,0.1)",
      color: "#D97757",
      border: "rgba(226,145,111,0.2)",
    },
    ACTIVE: {
  ...
  const DropdownItem = ({ label, value, current, onClick }) => (
    <button
      ...
      style={{
        ...
        padding: "8px 14px",
        border: "none",
        background: current === value ? "#D97757" : "transparent",
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => (e.currentTarget.style.background = BUTTON_DARK_HOVER)}
          onMouseLeave={(e) => (e.currentTarget.style.background = BUTTON_DARK)}
        >
        ...
        <div style={{ position: "relative" }}>
          <button
            ...
            style={{
              ...
              padding: "9px 13px",
              borderRadius: 9,
              border: `1px solid ${filterStatus !== "ALL" ? "#D97757" : border}`,
              background:
                filterStatus !== "ALL" ? "rgba(217,119,87,0.08)" : inputBg,
              color: filterStatus !== "ALL" ? "#D97757" : textSecondary,
              fontSize: 12,
              fontFamily: "'Poppins', sans-serif",
              cursor: "pointer",
            }}
