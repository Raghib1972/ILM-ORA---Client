      ...
      >
        ...
        <div
          style={{
            ...
            background: isUser ? t.text : t.iconBg,
        ...
        {!isUser && done && (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              color: copied ? t.text : t.textMuted,
              fontSize: 10,
              fontFamily: "'Poppins', sans-serif",
              fontWeight: 600,
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 12,
        cursor: "pointer",
        border: `1px solid ${hov ? t.borderHov : border}`,
          ...
          sessions.map((s) => {
            ...
            return (
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = t.recentItemBgHov;
                }}
                onMouseLeave={(e) => {
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 7,
            border: `1px solid ${border}`,
            background: additionalContext ? t.iconBg : "transparent",
            cursor: "pointer",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            color: additionalContext ? t.text : textSecondary,
            flexShrink: 0,
            transition: "all 0.15s",
          }}
        >
        ...
        <div style={{ position: "relative" }}>
          <button
            ...
            style={{
              ...
              padding: "6px 10px",
              borderRadius: 7,
              border: `1px solid ${selectedMode ? t.text : border}`,
              background: selectedMode ? t.iconBg : "transparent",
              color: selectedMode ? t.text : textSecondary,
              cursor: "pointer",
              fontSize: 12,
              fontFamily: "'Poppins', sans-serif",
              fontWeight: 500,
              ...
              {allModes.map((m) => (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background:
                      selectedMode?.mode === m.mode ? t.iconBg : "transparent",
                    textAlign: "left",
                    fontSize: 12,
                    color: selectedMode?.mode === m.mode ? t.text : t.text,
                    cursor: "pointer",
                    fontFamily: "'Poppins', sans-serif",
                    display: "flex",
                    alignItems: "center",
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 10,
            border: "none",
            background: input.trim() && !loading ? t.text : t.iconBg,
            ...
            transition: "all 0.15s",
            flexShrink: 0,
            boxShadow: input.trim() && !loading ? t.shadow : "none",
          }}
        >
          {loading ? (
            <span
            ...
            <Send
              size={14}
              color={input.trim() && !loading ? t.pageBg : t.textMuted}
            />
          )}
        </button>
      </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: isActive ? t.text : textSecondary,
                    fontSize: 13,
