...
//   const accent = "#D97757";
//   const accentBg = isDark ? "rgba(217,119,87,0.12)" : "#FCEAE3";
//   const hoverBg = isDark ? "rgba(255,255,255,0.05)" : "#f1f5f9";
//   const todayBg = isDark ? "rgba(217,119,87,0.25)" : "#FCEAE3";
//   const inputBg = isDark ? "#1a2333" : "#f8fafc";
//   const userMsgBg = isDark ? "rgba(217,119,87,0.15)" : "#FCEAE3";
...
//                 height: 3,
//                 borderRadius: "50%",
//                 background: isSel ? "#E2916F" : accent,
//               }}
//             />
//           )}
//         </button>,
...
//             e.currentTarget.style.background = "#C2653F";
//         }}
//         onMouseLeave={(e) => {
//           if (transcribing !== "general")
...
export default function AiMeetings({ isDark, onNavigate, onTranscriptStart }) {
  ...
  const bg = isDark ? T.dark.pageBg : T.light.pageBg;
  const card = isDark ? T.dark.cardBg : T.light.cardBg;
  const border = isDark ? T.dark.border : T.light.border;
  const softBorder = isDark ? T.dark.recentItemBgHov : T.light.recentItemBgHov;
  const text = isDark ? T.dark.text : T.light.text;
  const textSub = isDark ? T.dark.textMuted : T.light.textMuted;
  const textMuted = isDark ? T.dark.textMuted : T.light.textMuted;
  const accent = t.text;
  const accentBg = isDark ? T.dark.iconBg : T.light.iconBg;
  const hoverBg = isDark ? T.dark.recentItemBgHov : T.light.recentItemBgHov;
  const todayBg = isDark ? T.dark.iconBg : T.light.iconBg;
  const inputBg = isDark ? T.dark.inputBg : T.light.inputBg;
  const userMsgBg = isDark ? T.dark.iconBg : T.light.iconBg;
  const aiMsgBg = isDark ? T.dark.recentItemBgHov : T.light.recentItemBgHov;
          ...
          {hasSess && (
            <span
              style={{
                ...
                height: 3,
                borderRadius: "50%",
                background: isSel ? t.iconBg : accent,
              }}
            />
          )}
        </button>,
            ...
            {mode && (
              <span
                style={{
                  fontSize: 9,
                  color: textSub,
                  background: isDark ? T.dark.recentItemBgHov : T.light.recentItemBgHov,
                  border: `1px solid ${border}`,
                  padding: "2px 8px",
                  borderRadius: 20,
                  fontFamily: "'Poppins', sans-serif",
